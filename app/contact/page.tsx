      ...
      <div className='min-h-screen bg-gradient-to-b from-pink-100 to-purple-100 p-8'>
        <div className='max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-8 text-center'>
          ...
          <p className='text-lg text-gray-700'>
            Você é como um livro pelo qual todos os dias passei e nunca tive a chance de ler. Agora é o livro
            que eu quero ler todos os dias. 😊
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-pink-100 to-purple-100 p-8'>
      <div className='max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-8'>
        <h1 className='text-3xl font-bold text-center mb-8 text-purple-600'>Quase lá! 🎉</h1>
        ...
        <form
          ...
          <div>
            ...
            <textarea
              ...
              placeholder='Ex.: Lógico que aceito ser sua namorada...'
            />
